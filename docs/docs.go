...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/v1/admin/series/{series_id}/watch-history": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SeriesEpisodeWatchHistoryResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "created_at",
                        "description": "ソート対象フィールド (id または created_at)",
                        "name": "sort_key",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SeriesListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SeriesWithVideosResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SyobocalTitleSearchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/dto.SyobocalErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SyobocalSaveTitleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SyobocalSaveTitleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.ApiComment": {
            ...
            "properties": {
                "author": {
                    "description": "コメント投稿者ID（匿名の場合はnil）",
                    "type": "string"
                },
                "color": {
                    "description": "コメント色（16進数カラーコード）",
                    "type": "string"
                },
                "size": {
                    "description": "コメントサイズ",
        ...
        "dto.MutedCommentKeyword": {
            "type": "object",
            "properties": {
                "match": {
                    "description": "partial, forward, backward, exact, regex",
                    "type": "string"
                },
                "pattern": {
                    "type": "string"
        ...
        "dto.SeriesEpisodeResponse": {
            ...
            "properties": {
                ...
                "watch_history": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SeriesEpisodeWatchHistoryItem"
                    }
                }
            }
        },
        "dto.SeriesEpisodeWatchHistoryItem": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "視聴履歴ID",
                ...
                "watched_at": {
                    "description": "視聴日時（ISO 8601形式）",
                    "type": "string"
                }
            }
        },
        "dto.SeriesEpisodeWatchHistoryResponse": {
            "type": "object",
            "properties": {
                "episodes": {
                    "description": "エピソード別データ",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SeriesEpisodeResponse"
                    }
                },
                "series_id": {
                    "description": "シリーズID",
        ...
        "dto.SyobocalTitleSearchResponse": {
            "type": "object",
            "properties": {
                "titles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SyobocalTitleResponse"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "dto.VideoResponse": {
            ...
            "properties": {
                ...
                "comments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ApiComment"
                    }
                },
                "created_at": {
                    "type": "string"
